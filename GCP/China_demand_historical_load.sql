...
WHERE snap_mo_yr_key_no BETWEEN 202001 AND 202012 AND cntry_id IN (360, 50)),
...
WHERE ORD_CURCY IN ('360', '050')
    ...
    AND ORD_DT BETWEEN 20200101 AND 20201231)),
...
CAST(0 AS FLOAT64) AS prm_lc_net,
CAST(0 AS FLOAT64) AS prm_pv,
CAST(0 AS FLOAT64) AS prm_bv,
...
CAST(0 AS FLOAT64) AS catalog_ln_lc_net,
CAST(0 AS FLOAT64) AS catalog_ln_pv,
CAST(0 AS FLOAT64) AS catalog_ln_bv,
